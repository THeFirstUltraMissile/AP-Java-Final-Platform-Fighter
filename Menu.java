...
//        g.drawImage(Images.menuBackground,0, 0);
        g.drawImage(Images.menuLogo, 0, 0);
...
//        g.fillRect(0,0,1920,1080);
        ...
        if (!p1isReady) {
            g.drawString("Player 1 is not ready.", Main.getScreenWidth()/4-180, Main.getScreenHeight()/2+100);
        } else {
            g.drawString("Player 1 is ready!", Main.getScreenWidth()/4-180, Main.getScreenHeight()/2+100);
        }

        if (!p2isReady) {
            g.drawString("Player 2 is not ready.", Main.getScreenWidth()/4*3+180, Main.getScreenHeight()/2+100);
        } else {
            g.drawString("Player 2 is ready!", Main.getScreenWidth()/4*3+180, Main.getScreenHeight()/2+100);
        }


        g.drawString("Press the ; (semicolon) key to view the controls for the player", Main.getScreenWidth()-700, 300);
